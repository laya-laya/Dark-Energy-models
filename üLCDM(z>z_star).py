...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  1 02:18:51 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  1 02:03:34 2019
...
def fz(x,z):
    a = ((x**2)/(1+z))-((1.5*OM*((1+z)**2))/(1-((0.75*OM)/(1+z_star))-(0.25*OM*((1+z_star)**3))+ (OM * np.power(1 + z,3)))-(2/(1+z)))*x - (2*OM*((1+z)**2))/((E(z))**2)
    return a

tpoints = np.arange(0.537,3.001,0.001)

h = 0.001
x = 0.8210500003267928
fsigma8 = np.zeros(N)
x1 = np.zeros(N)
